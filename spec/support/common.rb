...
# Spec helpers adapted from camaleon_cms's spec/support/common.rb. Only the helpers the
# camaleon_editor specs actually use are ported.
...
def install_plugin_and_open_post_editor(as: nil)
