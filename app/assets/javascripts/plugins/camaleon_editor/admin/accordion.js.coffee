...
window.grid_accordion_builder = (panel, editor)->
  ...
  show_form = (tr)->
      ...
      open_modal({title: "Accordion Form", type: "primary", modal_size: "modal-lg", modal_settings: { keyboard: false, backdrop: "static" }, content: form, callback: form_callback, on_submit: submit_form_callback })
